...
export const TURBO_EDITS_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    { type: "link", content: " Get Spawn Pro", url: "https://spawn.sh/pro#ai" },
...
export const SMART_CONTEXT_PROMO_MESSAGE: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Spawn Pro's Smart Context",
      url: "https://spawn.sh/pro#ai",
    },
  ],
};
...
export const REDDIT_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "link",
      content: "Spawn subreddit",
      url: "https://www.reddit.com/r/spawnbuilders/",
    },
  ],
};
...
export const BUILD_A_BIBLE_APP_TIP: MessageConfig = {
  spans: [
    ...
    {
      type: "text",
      content: " the creator of Spawn build a Bible app step-by-step",
    },
  ],
};
...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.spawn.sh/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.spawn.sh/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.spawn.sh/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.spawn.sh/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.spawn.sh/docs/roadmap",
    },
  ],
};

// Like Spawn? Star it on GitHub https://github.com/spawn-sh/spawn/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    {
      type: "text",
      content: "Like Spawn? Star it on ",
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/spawn-sh/spawn",
    },
  ],
};
