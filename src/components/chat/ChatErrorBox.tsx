...
export function ChatErrorBox({
  ...
  if (error.includes("doesn't have a free quota tier")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        {error}
        <span className="ml-1">
          <ExternalLink href="https://spawn.sh/pro">
            Access with Spawn Pro
          </ExternalLink>
        </span>{" "}
  ...
  if (
    ...
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        <span className="ml-1">
          <ExternalLink href="https://spawn.sh/pro">
            Upgrade to Spawn Pro
          </ExternalLink>
        </span>{" "}
        or read the
        <span className="ml-1">
          <ExternalLink href="https://spawn.sh/docs/help/ai-rate-limit">
  ...
  if (error.includes("LiteLLM Virtual Key expected")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          Looks like you don't have a valid Spawn Pro key.{" "}
          <ExternalLink href="https://spawn.sh/pro">
            Upgrade to Spawn Pro
          </ExternalLink>{" "}
          today.
  ...
  if (isSpawnProEnabled && error.includes("ExceededBudget:")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          You have used all of your Spawn AI credits this month.{" "}
          <ExternalLink href="https://academy.spawn.sh/subscription">
            Upgrade to Spawn Max
          </ExternalLink>{" "}
