...
interface SpawnMcpToolResultProps {
  node?: any;
  children?: React.ReactNode;
}

export const SpawnMcpToolResult: React.FC<SpawnMcpToolResultProps> = ({
  node,
  children,
}) => {
  ...
  const prettyJson = useMemo(() => {
    ...
    try {
      ...
      console.error("Error parsing JSON for spawn-mcp-tool-result", e);
      return raw;
    }
  }, [expanded, raw]);
