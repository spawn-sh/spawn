...
export function registerSupabaseHandlers() {
  ...
  // Set app project - links a Spawn app to a Supabase project
  handle(
  ...
  // Unset app project - removes the link between a Spawn app and a Supabase project
  ...
  testOnlyHandle(
    ...
    async (
      ...
      safeSend(event.sender, "deep-link-received", {
        ...
        url: "https://supabase-oauth.spawn.sh/api/connect-supabase/login",
      });
      logger.info(
