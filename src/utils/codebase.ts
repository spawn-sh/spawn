...
const ALLOWED_EXTENSIONS = [
  ...
  ".swift",
  // Edge cases
  // https://github.com/spawn-sh/spawn/issues/880
  ".py",
  // https://github.com/spawn-sh/spawn/issues/1221
  ".php",
];
...
//
// ex: https://github.com/spawn-sh/spawn/issues/727
...
async function formatFile({
  ...
  try {
    ...
    if (!shouldReadFileContents({ filePath, normalizedRelativePath })) {
      return `<spawn-file path="${normalizedRelativePath}">
