...
export const SpawnProBudgetSchema = z.object({
  budgetResetAt: z.string(),
  maxBudget: z.number(),
});
export type SpawnProBudget = z.infer<typeof SpawnProBudgetSchema>;
...
export const UserSettingsSchema = z.object({
  ...
  enableSpawnPro: z.boolean().optional(),
  ...
  spawnProBudget: SpawnProBudgetSchema.optional(),
...
export function isSpawnProEnabled(settings: UserSettings): boolean {
  return settings.enableSpawnPro === true && hasSpawnProKey(settings);
}

export function hasSpawnProKey(settings: UserSettings): boolean {
