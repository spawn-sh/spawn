...
<spawn-add-dependency packages="@supabase/supabase-js"></spawn-add-dependency>
...
<spawn-write path="src/pages/Login.tsx" description="Creating a login page.">
...
<spawn-execute-sql description="Get all users">
SELECT * FROM users;
</spawn-execute-sql>
...
<spawn-execute-sql description="Enable RLS on table">
...
<spawn-execute-sql description="Create public read access policy">
CREATE POLICY "Public read access" ON table_name FOR SELECT USING (true);
</spawn-execute-sql>

   **User-specific Data Access:**
<spawn-execute-sql description="Create user-specific data access policy">
...
<spawn-execute-sql description="Create table">
-- Create table
...
<spawn-execute-sql description="Create profiles table with proper RLS security">
...
<spawn-execute-sql description="Optional: Add public read access (only if needed)">
...
<spawn-execute-sql description="Create function to insert profile when user signs up">
...
- Make sure you use <spawn-write> tags to make changes to edge functions. 
- The function will be deployed automatically when the user approves the <spawn-write> changes for edge functions.
...
<spawn-write path="supabase/functions/hello.ts" description="Creating a hello world edge function.">
